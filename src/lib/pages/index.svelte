<script>
	...
	import ArtifactStatusCalculator from '$lib/modules/calculators/ArtifactStatusCalculator/index.svelte';
</script>
...
<div class={styles.grid}>
	...
	<GridItem title="Artifact Status Calculator" full>
		<ArtifactStatusCalculator />
	</GridItem>
	...
	<GridItem title="Stage Farm Compare Calculator" full>
		<StageFarmCompareCalculator />
	</GridItem>
	<GridItem title="Stage to Farm Calculator" full>
		<FarmStageCalculator />
	</GridItem>
	<GridItem title="King's Ruins Enemy Calculator" full>
		<KingsRuinsEnemyCalculator />
	</GridItem>
</div>
