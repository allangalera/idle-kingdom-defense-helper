...
import { returnAbilityName, type Abilities } from '$lib/utils/abilities';
...
export const calculateArtifactStats = ({
	...
	return {
		type: type,
		name: returnAbilityName(artifactConst.ABILITY?.[type - 1] ?? 0),
		abilityType: artifactConst.ABILITY[type - 1],
