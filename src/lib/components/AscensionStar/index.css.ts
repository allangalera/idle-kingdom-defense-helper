...
export const icon = style({
  ...
  // stroke: theme.baseColor.ascensionList[0],
  // background:
  // 'radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(255, 255, 255,1) 50%, rgba(247,222,9,1) 63%, rgba(210,190,23,1) 67%, rgba(184,168,32,1) 100%)',
});
